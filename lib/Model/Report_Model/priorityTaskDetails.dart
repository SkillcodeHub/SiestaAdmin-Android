class PriorityTaskDetailsModel {
  bool? status;
  String? message;
  List<ScheduledActivitiesDetails>? data;
  dynamic meta;

  PriorityTaskDetailsModel({this.status, this.message, this.data, this.meta});

  PriorityTaskDetailsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <ScheduledActivitiesDetails>[];
      json['data'].forEach((v) {
        data!.add(new ScheduledActivitiesDetails.fromJson(v));
      });
    }
    meta = json['meta'];
  }
...
class ScheduledActivitiesDetails {
  int? schedulerId;
  dynamic slipNo;
  ...
  ScheduledActivitiesDetails.fromJson(Map<String, dynamic> json) {
