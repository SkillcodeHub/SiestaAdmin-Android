class ScheduledActivitiesModel {
  bool? status;
  String? message;
  List<ScheduledActivities>? data;
  dynamic meta;

  ScheduledActivitiesModel({this.status, this.message, this.data, this.meta});

  ScheduledActivitiesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <ScheduledActivities>[];
      json['data'].forEach((v) {
        data!.add(new ScheduledActivities.fromJson(v));
      });
    }
    meta = json['meta'];
  }
...
class ScheduledActivities {
  ...
  ScheduledActivities.fromJson(Map<String, dynamic> json) {
